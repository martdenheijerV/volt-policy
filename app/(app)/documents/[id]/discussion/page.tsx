...
export default async function DiscussionConfigPage({
  ...
  const [platformLabel, urlLabel, otherLabel, saveLink] = await Promise.all([
    tr("Platform"),
    tr("URL"),
    tr("Other"),
    tr("Save link"),
  ...
  return (
    <div className="max-w-xl">
      ...
      <p className="mt-1 text-sm text-slate-600">
        <T>
          Link this document to a thread on Slack, Mattermost, Element or
          Discord. Members will see an &ldquo;Open discussion&rdquo; button on
          the document.
        </T>
      </p>
